...
const Login = () => {
  ...
  return (
    ...
    <Stack pl={8} pr={8} pt={10} pb={10} margin="0 auto" borderRadius={ isMobile ? "0px" :"10px"} backgroundColor={ isMobile ? null : "#f4f4f4"} width={isMobile ? "100vw" : null} height={isMobile ? "100vh" : null} display={theme.flexBox} justifyContent={theme.center} alignItems={theme.center}>
