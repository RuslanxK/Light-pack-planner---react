...
const handleSubmit = (e) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} style={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", backgroundColor:"rgba(255,255,255, 0.6)", padding: "25px", borderRadius:"10px"}}>
    <Typography component="h1" variant='span' fontSize="2.2em" mb={2}>Log in to Planner</Typography>
    <TextField label="Email" name="email" sx={{marginBottom: "15px", background: "white", width: "330px"}} />
    <TextField label="Password" name='password' sx={{marginBottom: "15px", background: "white", width: "330px"}} />
