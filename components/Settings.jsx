...
import { Typography, Stack, TextField, Container, useTheme} from '@mui/material'
...
const Settings = () => {
  ...
  return (
    ...
    <Typography component="h2" variant="h6" mt={4} mb={0.5}>
      Payment method
    </Typography>
    ...
    <FormControl>
      ...
      >
        ...
        <TextField  type='email' size='small' label="email" sx={{marginTop: "5px", width: "400px", '& .MuiOutlinedInput-root': {'& fieldset': {borderColor: "black" },
