...
const logOut = () => {
  ...
  return (
     <div class="menu-mobile">
         ...
         {openHamburger ? <Stack p={2} backgroundColor="white" mt={39} right="35px" zIndex="99" position="absolute" width="220px" height="auto" borderRadius="7px" boxShadow="rgba(0, 0, 0, 0.1) -4px 9px 25px -6px;">
